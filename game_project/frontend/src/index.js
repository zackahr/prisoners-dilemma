...
import RootLayout from "./ultimatum/RootLayout"
import { getOrCreateFingerprint } from "./ultimatum/fingerprint";

/* very light context to share matchId / fp (optional but handy) */
...
export const UltCtx = React.createContext();
...
root.render(
  <React.StrictMode>
    <GlobalModalBus />
    <BrowserRouter>
      <UltCtx.Provider value={{ fingerprint: getOrCreateFingerprint() }}>
        <Routes>
        {/* Home landing page */}
